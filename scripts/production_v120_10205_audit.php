...
// allowed only for the exact withdrawn 10205 acceptance project and asset.
define('CURSCRIPT', 'forum');
$_SERVER['REMOTE_ADDR'] = '127.0.0.1';
$_SERVER['HTTP_HOST'] = 'stk.zz-yihao.com';
$_SERVER['SERVER_NAME'] = 'stk.zz-yihao.com';
define('STK_10205_CLEANUP_REQUESTED', getenv('STK_10205_CLEANUP') === '1');
...
$ownerUid = 9;
$title = 'STK10205FINAL';
$cleanup = STK_10205_CLEANUP_REQUESTED;

function emit10205(string $label, $value): void
{
    echo $label . PHP_EOL;
...
emit10205('MODE', $cleanup ? 'cleanup' : 'inspect');
emit10205('PROJECTS', $projects);
emit10205('PROJECT_IMAGES', $images);
emit10205('PROJECT_UPLOADS', $uploads);
emit10205('UPLOAD_FILE_CHECKS', $fileChecks);
emit10205('AUDIT_LOGS', $auditLogs);
...
try {
    ...
    DB::insert('stk_project_audit_log', [
        ...
        'from_status' => 'deleted',
        'to_status' => 'deleted',
        'reason' => 'STK V1.2.0 10205 real-device acceptance asset cleanup',
