...
| Host | 用途 | TLS | Owner动作 |
|---|---|---|---|
| stk-download.zz-yihao.com | 正式 APK 下载与校验 | True | V1.4 解析到不可变发布目录或受控下载服务 |

## 发布前检查
| Host | 服务版本 | 检查 |
|---|---|---|
| stk.zz-yihao.com | V1.4.0 | DNS生效、TLS有效、Host路由正确、健康检查通过、日志可追踪 |
...
| stk-download.zz-yihao.com | V1.4.0 | DNS生效、TLS有效、Host路由正确、健康检查通过、日志可追踪 |
